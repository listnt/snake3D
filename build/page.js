...
// include: /tmp/emscripten_temp/tmpq0a8g3tb.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/page.data';
...
Module['FS_createPath']("/", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/page.data');

      };
      Module['addRunDependency']('datafile_build/page.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/.frag", "start": 0, "end": 837}, {"filename": "/shaders/.vert", "start": 837, "end": 1307}], "remote_package_size": 1307});
